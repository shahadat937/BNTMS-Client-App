...
export class MaterialByCourseListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.schoolDashboardService.getReadingMetarialByCourse(courseNameId,this.schoolId).subscribe(response => {         
