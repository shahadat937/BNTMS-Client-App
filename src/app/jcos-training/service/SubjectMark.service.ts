...
export class SubjectMarkService {
  ...
  getSelectedSubjectNameByBranchId(saylorSubBranchId){
    return this.http.get<SelectedModel[]>(this.baseUrl + '/bna-subject-name/get-selectedSubjectNameBySailorSubBranchId?saylorSubBranchId='+saylorSubBranchId)
  }
