  ...
  // },
   {
    ...
    children: [
      ...
      { 
        path: 'record-of-service-details/:traineeId',  
        component: RecordOfServiceListComponent
      },
      { 
        path: 'add-record-of-service-details/:traineeId', 
        component: NewRecordOfServiceComponent
      },
      { 
        path: 'update-record-of-service-details/:traineeId/:recordOfServiceId', 
        component: NewRecordOfServiceComponent
      },

      //military training
      { 
        path: 'militarytraining-details/:traineeId',  
        component: MilitaryTrainingListComponent
      },
      { 
        path: 'add-militarytraining-details/:traineeId', 
        component: NewMilitaryTrainingComponent
      },
      { 
        path: 'update-militarytraining/:traineeId/:militaryTrainingId', 
        component: NewMilitaryTrainingComponent
      },

       //covid vaccine
       { 
        path: 'covidvaccine-details/:traineeId',  
        component: CovidVaccineListComponent
      },
      { 
        path: 'add-covidvaccine/:traineeId', 
        component: NewCovidVaccineComponent
      },
      { 
        path: 'update-covidvaccine/:traineeId/:covidVaccineId', 
        component: NewCovidVaccineComponent
      },
