...
export class BNASubjectNameService {
 ...
 // subject-category/get-selectedSubjectCategories
  ...
  getSubjectListbyBnaSemesterId(bnaSemesterId:number){ 
    return this.http.get<BNASubjectName[]>(this.baseUrl + '/bna-subject-name/get-bnaSubjectNameListByBnaSemesterId?bnaSemesterId='+bnaSemesterId)
   }
  ...
  // getSelectedsubjectsBySchoolAndCourseForAssignment(baseSchoolNameId:number,courseNameId:number){
  //   return this.http.get<SelectedModel[]>(this.baseUrl + '/bna-subject-name/get-selectedSubjectNamesBySchoolAndCourseforAssignment?baseSchoolNameId='+baseSchoolNameId+'&courseNameId='+courseNameId)
  // }

  getSelectedsubjectsBySchoolAndCourseForAssignment(baseSchoolNameId,courseNameId){
    return this.http.get<SelectedModel[]>(this.baseUrl + '/bna-subject-name/get-selectedSubjectNameForAssignments?baseSchoolNameId='+baseSchoolNameId+'&courseNameId='+courseNameId)
  }
  ...
  activeSubject(id: number) {
    return this.http.get<BNASubjectName>(this.baseUrl + '/bna-subject-name/active-bna-subjectname/'+id);
  }

  deActiveSubjectName(id: number) {
    return this.http.get<BNASubjectName>(this.baseUrl + '/bna-subject-name/deactive-bna-subjectname/'+id);
  }
